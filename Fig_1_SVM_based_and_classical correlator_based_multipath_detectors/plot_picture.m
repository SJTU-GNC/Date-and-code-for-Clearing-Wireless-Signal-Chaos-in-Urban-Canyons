...
load ('G:\code_only\code_only\仿真_多径参数验证\viald_result_40dB_bds_NEPLA.mat')
load ('G:\code_only\code_only\仿真_多径参数验证\viald_result_40dB_BOC_NEPLA.mat')
...
% 1. 定义离散colormap（5种颜色）
% numColors = 6;
% custom_map = [23./255 31./255 74./255;   % 深蓝黑，增强深度感
%               % 0.1020 0.2118 0.3686;   % 海军蓝
%               46./255 78./255 144./255;   % 深蓝
%               % 0.2588 0.5098 0.6627;   % 中蓝
%               92./255 157./255 213./255;   % 天蓝
%               % 0.5882 0.8039 0.8706;   % 浅天蓝
%               % 0.8510 0.9216 0.9373;   % 极浅蓝
%               0.9412 0.9412 0.9412;   % 近纯白(中间色)
%               % 0.9961 0.9255 0.8196;   % 极浅杏
%               253./255 190./255 111./255;   % 浅杏
%               % 0.9804 0.6588 0.4510;   % 淡橙
%               230./255,84./255,12./255;];   % 橙
